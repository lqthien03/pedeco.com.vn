...
<head>
    ...
    <link href="./assets/css/animate.min.css?v=kRGcim4os" rel="stylesheet">
        ...
        <div class="menu tss">
            <div class="flex wrap ja wap_1200">
                ...
                <ul class="menu_desktop flex ja">
                    <li><a class="transition " href="/home" title="Trang chủ">
                            <h2>Trang chủ</h2>
                        </a></li>
                    <li><a class="transition active" href="/about" title="Giới thiệu">
                            <h2>Giới thiệu</h2>
                        </a>
                        <ul>
                            <li><span></span><a href="/open-letter">
                                    <h2>Thư ngỏ</h2>
                                </a></li>
                            <li><span></span><a href="/about-us">
                                    <h2>Về chúng tôi</h2>
                                </a></li>
                            <li><span></span><a href="/resource-structure">
                                    <h2>Cơ cấu nguồn lực</h2>
                                </a></li>
                            <li><span></span><a href="/overview">
                                    <h2>Tổng quan Khu Liên Hợp Xử Lý Chất Thải Lagi</h2>
                                </a></li>
                            <li><span></span><a href="/transport">
                    ...
                    <div class="righttt">
                        <div class="item_gt">
                            <div class="flex ja wrap">
                                <a class="hover_sang1 sp_img img_gt" href="/open-letter" title="Thư ngỏ">
                                ...
                                <div class="ndgt">
                                    <h3 class="gt_name"><a class="catchuoi1" href="/open-letter" title="Thư ngỏ">Thư
                                            ngỏ</a></h3>
                        ...
                        <div class="item_gt">
                            <div class="flex ja wrap">
                                <a class="hover_sang1 sp_img img_gt" href="/about-us" title="Về chúng tôi">
                                    <img onerror="this.src='thumbs/100x100x2/assets/images/noimage.png';"
                                        src="thumbs/100x100x2/upload/news/download-7089.jpg" alt="Về chúng tôi">
                                </a>
                                <div class="ndgt">
                                    <h3 class="gt_name"><a class="catchuoi1" href="/about-us"
                        ...
                        <div class="item_gt">
                            <div class="flex ja wrap">
                                <a class="hover_sang1 sp_img img_gt" href="/resource-structure"
                                    title="Cơ cấu nguồn lực">
                                    <img onerror="this.src='thumbs/100x100x2/assets/images/noimage.png';"
                                        src="thumbs/100x100x2/upload/news/26394-3327.jpg" alt="Cơ cấu nguồn lực">
                                </a>
                                <div class="ndgt">
                                    <h3 class="gt_name"><a class="catchuoi1" href="/resource-structure"
                        ...
                        <div class="item_gt">
                            <div class="flex ja wrap">
                                <a class="hover_sang1 sp_img img_gt" href="/overview"
                                ...
                                <div class="ndgt">
                                    <h3 class="gt_name"><a class="catchuoi1" href="/overview"
                        ...
                        <div class="item_gt">
                            <div class="flex ja wrap">
                                <a class="hover_sang1 sp_img img_gt" href="/transport" title="Năng lực vận chuyển">
                                    <img onerror="this.src='thumbs/100x100x2/assets/images/noimage.png';"
                                        src="thumbs/100x100x2/upload/news/nang-luc-van-chuyen-7975-1005-1006.jpg"
                                        alt="Năng lực vận chuyển">
                                </a>
                                <div class="ndgt">
                                    <h3 class="gt_name"><a class="catchuoi1" href="/transport"
