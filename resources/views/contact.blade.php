...
<head>
    ...
    <link href="./assets/css/animate.min.css?v=2CASzAntEK" rel="stylesheet">
    <link href="./assets/bootstrap/bootstrap.css?v=iNbu8APtnI" rel="stylesheet">
    <link href="./assets/css/all.css?v=5iFMSyJCU4" rel="stylesheet">
    <link href="./assets/fancybox3/jquery.fancybox.css?v=RXKx8TMvdw" rel="stylesheet">
    <link href="./assets/fancybox3/jquery.fancybox.style.css?v=MBIK5gfTqe" rel="stylesheet">
    <link href="./assets/login/login.css?v=HqyVCOxTTn" rel="stylesheet">
    <link href="./assets/css/cart.css?v=DT9uoujzD3" rel="stylesheet">
    <link href="./assets/photobox/photobox.css?v=V3L4RU8L" rel="stylesheet">
    <link href="./assets/slick/slick.css?v=hoL0iWwWlA" rel="stylesheet">
    <link href="./assets/slick/slick-theme.css?v=7UnI9ywooJ" rel="stylesheet">
    <link href="./assets/slick/slick-style.css?v=hthwmHhWKW" rel="stylesheet">
    <link href="./assets/simplyscroll/jquery.simplyscroll.css?v=9M28cXDUZX" rel="stylesheet">
    <link href="./assets/simplyscroll/jquery.simplyscroll-style.css?v=keFtr2BJLj" rel="stylesheet">
    <link href="./assets/fotorama/fotorama.css?v=DZwxupfGvF" rel="stylesheet">
    <link href="./assets/fotorama/fotorama-style.css?v=05BiD7hPrR" rel="stylesheet">
    <link href="./assets/magiczoomplus/magiczoomplus.css?v=JWtijr1LQX" rel="stylesheet">
    <link href="./assets/datetimepicker/jquery.datetimepicker.css?v=C1tlctUNUm" rel="stylesheet">
    <link href="./assets/owlcarousel2/owl.carousel.css?v=ZbCQz5lm0T" rel="stylesheet">
    <link href="./assets/owlcarousel2/owl.theme.default.css?v=m1nL4Km5Km" rel="stylesheet">
    <link href="./assets/css/style.css?v=GaLA3ww27" rel="stylesheet">
    <link href="./assets/css/media.css?v=vdwboiTpwx" rel="stylesheet">
    ...
    <div class="wap_main">
        ...
        <div class="breadCrumbs">
            <div class="wrap-content">
                ...
                <script type="application/ld+json">{"@context": "https://schema.org","@type": "BreadcrumbList","itemListElement": [{"@type":"ListItem","position":1,"name":"Gi\u1edbi thi\u1ec7u","item":"http:\/\/pedaco.com.vn\/gioi-thieu"}]}</script>
            </div>
        </div>
                ...
                <div class="w-clear">
                            ...
                            <div class="flex ja wrap">
                                <a class="hover_sang1 sp_img img_gt" href="thu-ngo" title="Thư ngỏ">
                                    <img onerror="this.src='thumbs/100x100x2/assets/images/noimage.png';"
                                        src="thumbs/100x100x2/upload/news/hinh-an-5496.jpg" alt="Thư ngỏ">
                                </a>
                                <div class="ndgt">
                                    <h3 class="gt_name"><a class="catchuoi1" href="thu-ngo" title="Thư ngỏ">Thư
                                            ngỏ</a></h3>
                                    <p class="mtgt catchuoi2"> PEDACO, là một trong những đơn vị tư vấn môi trường, có
                                        đầy đủ năng lực và chức năng về thu gom Chất thải công nghiệp, chất thải nguy
                                        hại, chất thải sinh hoạt và một số dịch vụ đi kèm như: thu mua phế liệu, thu mua
                                        và tái chế dầu nhớt thải.</p>
                                </div>
                            </div>
                        </div>
                        <div class="item_gt">
                            <div class="flex ja wrap">
                                <a class="hover_sang1 sp_img img_gt" href="gioi-thieu-ve-chu-dau-tu"
                                    title="Về chúng tôi">
                                    <img onerror="this.src='thumbs/100x100x2/assets/images/noimage.png';"
                                        src="thumbs/100x100x2/upload/news/download-7089.jpg" alt="Về chúng tôi">
                                </a>
                                <div class="ndgt">
                                    <h3 class="gt_name"><a class="catchuoi1" href="gioi-thieu-ve-chu-dau-tu"
                                            title="Về chúng tôi">Về chúng tôi</a></h3>
                                    <p class="mtgt catchuoi2">Công ty Cổ phần Môi trường Xanh PEDACO hoạt động theo
                                        giấy phép đăng ký kinh doanh và đăng ký thuế số 3401201904 do Sở Kế hoạch &amp;
                                        Đầu tư tỉnh Bình Thuận cấp lần thứ 4 ngày 23 tháng 12 năm 2021.</p>
                                </div>
                            </div>
                        </div>
                        <div class="item_gt">
                            <div class="flex ja wrap">
                                <a class="hover_sang1 sp_img img_gt" href="co-cau-nguon-luc-cong-ty"
                                    title="Cơ cấu nguồn lực">
                                    <img onerror="this.src='thumbs/100x100x2/assets/images/noimage.png';"
                                        src="thumbs/100x100x2/upload/news/26394-3327.jpg" alt="Cơ cấu nguồn lực">
                                </a>
                                <div class="ndgt">
                                    <h3 class="gt_name"><a class="catchuoi1" href="co-cau-nguon-luc-cong-ty"
                                            title="Cơ cấu nguồn lực">Cơ cấu nguồn lực</a></h3>
                                    <p class="mtgt catchuoi2">Đội ngũ nhân sự Công ty chính là giá trị cốt lõi, nhân tố
                                        quan trọng tạo nên sự thành công của đơn vị. Ban Lãnh đạo PEDACO luôn chú trọng
                                        trong công tác đào tạo, nâng cao trình độ chuyên môn cho đội ngũ CB-CNV.</p>
                                </div>
                            </div>
                        </div>
                        <div class="item_gt">
                            <div class="flex ja wrap">
                                <a class="hover_sang1 sp_img img_gt" href="hieu-chung"
                                    title="Tổng quan Khu Liên Hợp Xử Lý Chất Thải Lagi">
                                    <img onerror="this.src='thumbs/100x100x2/assets/images/noimage.png';"
                                        src="thumbs/100x100x2/upload/news/environmental-audit-reporting-good-pr-or-bad-press-5124.jpg"
                                        alt="Tổng quan Khu Liên Hợp Xử Lý Chất Thải Lagi">
                                </a>
                                <div class="ndgt">
                                    <h3 class="gt_name"><a class="catchuoi1" href="hieu-chung"
                                            title="Tổng quan Khu Liên Hợp Xử Lý Chất Thải Lagi">Tổng quan Khu Liên Hợp
                                            Xử Lý Chất Thải Lagi</a></h3>
                                    <p class="mtgt catchuoi2">Cải thiện chất lượng môi trường sống cho người dân trên
                                        địa bàn thị xã La Gi, tạo ra môi trường thuận lợi về xử lý chất thải để thu hút
                                        các nhà đầu tư đến đầu tư tại địa phương.</p>
                                </div>
                            </div>
                        </div>
                        <div class="item_gt">
                            <div class="flex ja wrap">
                                <a class="hover_sang1 sp_img img_gt" href="nang-luc-van-chuyen"
                                    title="Năng lực vận chuyển">
                                    <img onerror="this.src='thumbs/100x100x2/assets/images/noimage.png';"
                                        src="thumbs/100x100x2/upload/news/nang-luc-van-chuyen-7975-1005-1006.jpg"
                                        alt="Năng lực vận chuyển">
                                </a>
                                <div class="ndgt">
                                    <h3 class="gt_name"><a class="catchuoi1" href="nang-luc-van-chuyen"
                                            title="Năng lực vận chuyển">Năng lực vận chuyển</a></h3>
                    ...
                    <div class="lefttt">
                        ...
                        <ul>
                            ...
                            <li><a href="hieu-chung" title="Tổng quan Khu Liên Hợp Xử Lý Chất Thải Lagi">Tổng quan Khu
